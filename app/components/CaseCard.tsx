...
export default function CaseCard({ study, headingLevel = "h3" }: { study: CaseStudy; headingLevel?: "h2" | "h3" }) {
    ...
    <article className="group grid border-t border-border py-9 lg:grid-cols-[8rem_1fr] lg:gap-8">
      ...
      <div>
        ...
        <div className="mt-3 grid gap-6 xl:grid-cols-[1fr_17rem] xl:items-start">
          <div>
            <Heading className="max-w-3xl text-2xl font-semibold leading-tight tracking-[-0.035em] md:text-3xl">
