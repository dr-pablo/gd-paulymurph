      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-14 md:px-8 md:py-20 lg:grid-cols-[0.75fr_1.25fr] lg:items-start">
        <div className="lg:sticky lg:top-28">
          ...
          <p className="mt-7 max-w-lg text-lg leading-8 text-muted-foreground">
            This assistant retrieves from approved case-study content, cites what it used, and exposes a limited execution trace. It does not have access to former client systems or the private home lab.
          </p>
          <div className="mt-9 border-l-2 border-lavender pl-4 font-mono text-[0.67rem] leading-5 text-muted-foreground">
            No vector database. No mystery corpus. Typed content, explicit retrieval, server-side model boundary.
          </div>
        </div>
        <PortfolioAssistant />
      </div>
